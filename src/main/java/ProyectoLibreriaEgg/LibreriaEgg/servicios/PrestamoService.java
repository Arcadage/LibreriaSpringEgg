package ProyectoLibreriaEgg.LibreriaEgg.servicios;

import java.util.Date;
import java.util.List;
import java.util.Optional;
import ProyectoLibreriaEgg.LibreriaEgg.entidades.Cliente;
import ProyectoLibreriaEgg.LibreriaEgg.entidades.Libro;
import ProyectoLibreriaEgg.LibreriaEgg.entidades.Prestamo;
import ProyectoLibreriaEgg.LibreriaEgg.excepciones.ClienteServiceException;
import ProyectoLibreriaEgg.LibreriaEgg.excepciones.LibroServiceException;
import ProyectoLibreriaEgg.LibreriaEgg.excepciones.PrestamoServiceException;
import ProyectoLibreriaEgg.LibreriaEgg.repositorios.ClienteRepositorio;
import ProyectoLibreriaEgg.LibreriaEgg.repositorios.LibroRepositorio;
import ProyectoLibreriaEgg.LibreriaEgg.repositorios.PrestamoRepositorio;
